...
contract Auction {
    ...
    function register(address _account, uint8 _token) public {
        ...
        require(msg.sender == auctioneer, "Only Auctioneer can register new Bidder!");
    ...
    function startSession() public {
        require(msg.sender == auctioneer, "Only Auctioneer can start session!");
        state = State.STARTED;
    }
    ...
    function bid(uint8 _price) public {
        ...
        /* Start code here */
        require(bidders[msg.sender].token > 0, "Only Bidder can bid!");
        require(state == State.STARTED, "Invalid State!");
    ...
    function announce() public {
        ...
        require(msg.sender == auctioneer, "Only Auctioneer can announce!");
        require(state == State.STARTED, "Invalid State!");
        announcementTimes += 1;
    ...
    function getDeposit() public {
        ...
        require(state == State.CLOSING, "Invalid State!");
